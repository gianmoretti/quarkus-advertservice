...
It produces the `advert-service-quarkus-1.0.0-SNAPSHOT-runner.jar` file in the `build` directory.
...
docker run --name advert-pg -e POSTGRES_PASSWORD=adverT_password -d postgres:latest
